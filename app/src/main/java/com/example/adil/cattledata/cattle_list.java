...
import static com.example.adil.cattledata.R.id.importa;

public class cattle_list extends AppCompatActivity implements AdapterView.OnItemClickListener,View.OnClickListener {
    SQLiteDatabase db;
    Dialog dialog;
    String a;
      ...
      lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
          ...
          public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
             String b= list.get(position);
              Intent intent = new Intent(cattle_list.this, ShowData.class);
    ...
    public void onClick(View v) {
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String b= list.get(position);
                Intent intent = new Intent(cattle_list.this, Product_display.class);
                intent.putExtra("first",a);
                intent.putExtra("second",b);
                startActivity(intent);
            }
